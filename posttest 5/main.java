...
// Final class Gitar
final class Gitar extends AlatMusik {
    public Gitar(String id, String nama, double harga, AlatMusikManager gitar) {
        super(id, nama, harga);
        setKategori(gitar, "Alat Musik Petik");
    }
    ...
    protected static void setKategori(AlatMusikManager gitar, String kategori){
        throw new UnsupportedOperationException("Not supported yet.");
    }
}

// Drum (bukan final class)
class Drum extends AlatMusik {
    public Drum(String id, String nama, double harga, Drum drum, AlatMusik Drum) {
        super(id, nama, harga);
        setKategori(Drum,"Alat Musik Perkusi");
    }

    public Drum(String id, String nama, double harga, AlatMusikManager alatMusikManager) {
...
class AlatMusikManager {
    ...
    public void tambahAlatMusik() {
        ...
        AlatMusik alatMusik;
        switch (pilihan) {
            case 1 -> alatMusik = new Gitar(id, nama, harga, this);
            case 2 -> alatMusik = new Drum(id, nama, harga, this);
            default -> {
                System.out.println("Pilihan tidak valid! Alat musik tidak dibuat.");
                return;
            }
        }
    ...
    public ArrayList<AlatMusik> getDaftarAlatMusik() {
        return daftarAlatMusik;
    }

    public void setDaftarAlatMusik(ArrayList<AlatMusik> daftarAlatMusik) {
        this.daftarAlatMusik = daftarAlatMusik;
    }
}
    ...
    public main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            do {
                ...
                System.out.println("5. Tampilkan Polymorphism");
                ...
                switch (pilihan) {
                    ...
                    case 5 -> manager.tampilkanPolymorphism();
